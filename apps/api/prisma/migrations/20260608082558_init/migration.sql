...
-- CreateEnum
CREATE TYPE "DiscountType" AS ENUM ('PERCENTAGE', 'FLAT', 'FIRST_PURCHASE', 'CATEGORY');

-- CreateEnum
CREATE TYPE "RefundStatus" AS ENUM ('PENDING', 'UNDER_REVIEW', 'APPROVED', 'REJECTED', 'PROCESSED');

-- CreateEnum
CREATE TYPE "CustomOrderStatus" AS ENUM ('PENDING', 'REVIEWED', 'QUOTED', 'ACCEPTED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED');
...
-- CreateIndex
CREATE INDEX "browsing_history_viewedAt_idx" ON "browsing_history"("viewedAt");

-- CreateIndex
CREATE UNIQUE INDEX "browsing_history_userId_productId_key" ON "browsing_history"("userId", "productId");
...
-- CreateIndex
CREATE INDEX "abandoned_cart_emails_userId_idx" ON "abandoned_cart_emails"("userId");
...
-- AddForeignKey
ALTER TABLE "browsing_history" ADD CONSTRAINT "browsing_history_productId_fkey" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE;
